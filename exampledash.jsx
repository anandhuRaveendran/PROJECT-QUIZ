...
const TravelAdminDashboard = () => {
    ...
    return (
        <div className="flex">
            <div className={`bg-white transition-all duration-500 ease-in-out h-screen md:h-[600px] gap-12 pl-4 rounded-br-lg
        shadow-md flex-col fixed z-10 sm:flex ${NavOpen ? "w-[200px] top-0 left-0" : "w-[78px] -left-52 sm:left-0"}
        `}>
                ...
                <div className="flex flex-col items-start gap-14 justify-between pr-5 py-5 h-full mt-5 md:mt-0">
                    <div className="flex flex-col gap-10 h-full">
                        {navitem.map((data, index) => {
                            return (
                                <div key={index} className={`flex gap-3 items-center ${NavOpen ? "hover:bg-[#D8FFFF] px-1 rounded-sm"
                                    : ""}`}>
                                    <div>
                                        <a href="#_"
                                    ...
                                    <span className={` ${NavOpen ? "block delay-700 delayed-text" : "hidden"}`}>
                                        {data.name}
                                    </span>
                                </div>
                            );
            ...
            <div className="w-full flex flex-col md:ml-20">
                <div className="px-5 md:px-10 py-5 bg-white flex items-center justify-between w-full fixed z-20">
                    ...
                    <div className="flex gap-12 md:mr-16">
                        <div>
                            <div
                                className="md:flex items-center bg-[#EFF7FF] rounded-3xl px-3 py-2.5 hidden border-transparent border-2 group focus-within:border-[#09D7C9]">
                                <img src="/assets/travelagency-admin/searchicon.svg" alt="search" />
                                <input type="text" placeholder="Search.."
                                    className="bg-transparent px-4 focus:outline-none group "></input>
                            </div>
                        </div>
                        <div className="flex items-center gap-2.5">
                            <a href="#_" className="md:hidden">
                                <img src="/assets/travelagency-admin/searchicon.svg" alt="searchicon" />
                            </a>
                            <a href="#_">
                            ...
                            <a href="#_">
                                <img src="/assets/travelagency-admin/profile.svg" alt="profileicon" />
                            </a>
                            <a href="#_" onClick={() => IsNavOpen(!NavOpen)}>
                                <img src="/assets/travelagency-admin/hamburger.svg" alt="" className="sm:hidden" />
                            </a>
                        </div>
                    </div>
                </div>
                <div className="transition-all duration-1000 ease-in-out">
                    <div className={`flex flex-col w-full justify-between gap-5 p-5 mt-20 ${NavOpen
                        ...
                        <div className="flex flex-col md:flex-col xl:flex-row w-full gap-5">
                            <div className="w-full bg-[#FDFDFD] rounded-md shadow-md pt-5 pb-2 flex flex-col gap-5">
                                        ...
                                        {cardinfo.map((data, index) => {
                                            return (
                                                <div key={index}
                                                    ...
                                                    <div
                                                        className="hover:shadow-lg p-5 w-full bg-white flex-col rounded-[11px] xl:rounded-[13px] flex gap-4 ">
                                                        ...
                                                        <div className="flex justify-between">
                                                            ...
                                                            <a href="#_" className="flex items-end text-[#10B860] text-sm font-medium">
                                                                Get report
                                                            </a>
                                                        </div>
                                                    </div>
                                ...
                                <div className="overflow-x-auto flex flex-col min-h-[300px]">
                                    <div
                                        className="w-full overflow-x-scroll md:overflow-auto max-w-xl xs:max-w-xl sm:max-w-xl md:max-w-7xl 2xl:max-w-none mt-1">
                                        <table
                                            className="table-auto overflow-scroll md:overflow-auto w-full text-left border-separate border-spacing-y-1">
                                            <tbody>
                                                        ...
                                                        <tr key={index}
                                                            ...
                                                            <td className="flex gap-1 whitespace-nowrap px-4">
                                                                <div className="flex items-center w-5">
                                                                    <img src="/assets/travelagency-admin/plane.svg" alt="" />
                                                                </div>
                                    ...
                                    <div className="flex justify-between px-5 items-end text-[#637381] mt-3 text-sm">
                                        ...
                                        <ReactPaginate className="flex gap-3 items-center" previousLabel={<LeftArrow />}
                                            nextLabel={
                                                <RightArrow />}
                                            breakLabel={"..."}
                                            pageCount={10}
                            ...
                            <div className="w-full xl:w-3/12 gap-5 flex flex-col md:flex-row xl:flex-col ">
                                <div
                                    className="w-full xl:w-full md:h-auto xl:h-1/2 bg-[#FDFDFD] rounded-xl px-5 py-5 flex flex-col justify-between gap-10 ">
                                    <div className="flex justify-between">
                                ...
                                {tophotel.map((data, index) => {
                                    return (
                                        <div key={index}
                                            ...
                                            <div
                                                className="flex justify-center w-[260px] md:w-[299px] opacity-100 transition duration-300 ease-in-out hover:opacity-80">
                                            ...
                                            <div className="w-full flex flex-col gap-4">
                                                ...
                                                <div className="flex gap-2 sm:gap-10 items-center xl:justify-between">
                                                    <button className={`${data.type === "Plus" ? "bg-[#09D7C9]" : data.type === "Lux"
                                                        ? "bg-[#F9C107]" : "bg-blue-600"} text-white rounded-3xl px-5 py-1 uppercase
                                        text-base`}>
                                                        {data.type}
                                                    </button>
                                                    <div
                                                        className="text-[#637381] font-semibold text-sm tracking-wider whitespace-nowrap truncate">
                                                ...
                                                <div className="text-[#637381] flex justify-between items-center">
                                                    ...
                                                    <div className="text-sm flex items-center gap-1">
                                                        <div>
                                                            <img src="/assets/travelagency-admin/star.svg" alt="" />
                                                        </div>
                                                        {data.rating}
                                                    </div>
                                                </div>
